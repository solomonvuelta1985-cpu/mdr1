<?php
/**
 * NDRRMC Annex 4: Damaged Houses - Print Template
...
<head>
    <meta charset="UTF-8">
    <title>NDRRMC Annex 4 - Damaged Houses</title>
    <style>
        @page {
...
<body>
    ...
    <div style="margin-top: 25px; font-size: 9pt; line-height: 1.6;">
        ...
        ?>
        Total Totally Damaged Houses: <strong><?php echo number_format($total_totally_damaged); ?></strong> &nbsp;|&nbsp;
        Total Partially Damaged Houses: <strong><?php echo number_format($total_partially_damaged); ?></strong><br>
        Total Damaged Houses: <strong><?php echo number_format($total_damaged); ?></strong>
    </div>
    <?php endif; ?>
