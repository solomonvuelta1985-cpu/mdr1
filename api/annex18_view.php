<?php
/**
 * API Handler: View Animal Evacuation Record Details (Annex 18)
 */
...
try {
    ...
    log_audit_action(
        $_SESSION['user_id'],
        'annex18_view',
        "Viewed animal evacuation record #{$record_id} for {$record['barangay']}"
    );
    ...
    log_security_event(
        $_SESSION['user_id'],
        'record_view',
        "Viewed Annex 18 record #{$record_id}"
    );
    
} catch (PDOException $e) {
    error_log("Annex18 View Error: " . $e->getMessage());
...
<div class="view-container">
    <!-- Header -->
    <div class="mb-4">
        <h5 class="mb-2">Animal Evacuation Report #<?php echo $record['id']; ?></h5>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <!-- Animal Details -->
            <div class="mb-4">
                <div class="section-header">Animal Details</div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value highlight"><?php echo number_format($record['quantity']); ?> heads</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Reason for Evacuation:</div>
                    <div class="info-value"><?php echo htmlspecialchars($record['evacuation_reason']); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <!-- Evacuation Details -->
            <div class="mb-4">
                <div class="section-header">Evacuation Details</div>
                <div class="info-row">
                    <div class="info-label">Temporary Shelter:</div>
                    <div class="info-value"><?php echo htmlspecialchars($record['shelter_location'] ?? 'Not specified'); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Assistance Provider:</div>
                    <div class="info-value"><?php echo htmlspecialchars($record['assistance_provider'] ?? 'Not specified'); ?></div>
                </div>
            </div>
