<?php
/**
 * API Handler: View Infrastructure Damage Record Details (Annex 6)
...
try {
    ...
    log_audit_action(
        $_SESSION['user_id'],
        'annex6_view',
        "Viewed infrastructure damage record #{$record_id} for {$record['barangay']}"
    );
    ...
    log_security_event(
        $_SESSION['user_id'],
        'record_view',
        "Viewed Annex 6 record #{$record_id}"
    );
...
<div class="view-container">
    <!-- Header -->
    <div class="mb-4">
        <h5 class="mb-2">Infrastructure Damage Report #<?php echo $record['id']; ?></h5>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-4">
                <div class="section-header">Infrastructure Details</div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><strong><?php echo htmlspecialchars($record['name'] ?: 'Not specified'); ?></strong></div>
                </div>
            </div>

            <!-- Damage Summary -->
            <div class="mb-4">
                <div class="section-header">Damage Summary</div>
                <div class="info-row">
                    <div class="info-label">Totally Damaged:</div>
                    <div class="info-value"><?php echo number_format($record['totally_damaged']); ?> units</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Partially Damaged:</div>
                    <div class="info-value"><?php echo number_format($record['partially_damaged']); ?> units</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Total Damaged:</div>
                    <div class="info-value highlight"><?php echo number_format($record['total_damaged']); ?> units</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="mb-4">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo number_format($record['quantity'], 2); ?></div>
                </div>
                <div class="info-row">
