<?php
/**
 * NDRRMC Annex 21: Assistance Provided to LGUs and Agencies Report
 * Secure PHP implementation with centralized barangay locking
 */

// Define page title for the header
define('PAGE_TITLE', 'Annex 21 - Assistance Provided to LGUs and Agencies');
...
if (!check_rate_limit($rate_limit_key, 100, 3600)) {
    log_security_event(
        $_SESSION['user_id'],
        'rate_limit_exceeded',
        'Annex 21 form access rate limit exceeded (100 per hour)'
    );
...
log_audit_action(
    $_SESSION['user_id'],
    'annex21_form_access',
    'User accessed the Annex 21 Assistance to LGUs form'
);
...
<body>
    <div class="form-container">
        ...
        <div id="formContent" class="form-content">
            <div class="header-section">
                ...
                <h2>Annex 21: Assistance Provided to LGUs and Agencies</h2>
            ...
            <form id="assistanceToLGUsForm" method="POST" action="../api/annex21_save.php">
                <!-- CSRF Token -->
                ...
                <div id="entriesContainer">
                    ...
                    <div class="entry-card lazy-entry loaded">
                        <div class="section-title">Location and Recipient Details</div>
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <label for="recipient-0" class="form-label">Recipient (LGU/Agency)</label>
                                <input type="text" class="form-control" id="recipient-0" name="recipient[]" placeholder="e.g., Municipality of Nabunturan" required maxlength="255">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="cluster-0" name="cluster[]" required>
                                    ...
                                    <option value="Camp Management">Camp Management</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="type-0" name="type[]" required>
                                    ...
                                    <option value="Sleeping kits">Sleeping kits</option>
                                    <option value="Medical supplies">Medical supplies</option>
                                    <option value="Shelter repair kits">Shelter repair kits</option>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control number-input" id="quantity-0" name="quantity[]" placeholder="0" min="0" onchange="calculateAmount(this)" required>
                            </div>
                            <div class="col-md-2">
                                <label for="unit-0" class="form-label">Unit</label>
                                <input type="text" class="form-control" id="unit-0" name="unit[]" placeholder="e.g., pack, piece" required maxlength="50">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control number-input" id="amount-0" name="amount[]" placeholder="0.00" readonly>
                            </div>
                        </div>

                        <div class="section-title mt-4">Source and Additional Information</div>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="source-0" class="form-label">Source</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <strong>General Guide:</strong> Tracks the provision of food and non-food items (F/NFIs) and other forms of assistance delivered to local government units (LGUs) and agencies to support their relief operations during or after a disaster.
                    </div>
                    
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <p><strong>Region, Province, City/Municipality</strong><br>
                            Specify the location where the recipient LGU or agency is based or where the assistance was delivered.</p>
                            
                            <p><strong>Recipient (LGU/Agency)</strong><br>
                            Include the specific name of the recipient (e.g., Municipality of Nabunturan, OCD Regional Office, PNP).</p>
                        ...
                        <div class="col-md-6">
                            ...
                            Measurement unit (e.g., pack, piece, liter, kilogram).</p>
                            ...
                            Identify the origin of the assistance (e.g., DSWD, DOH, LGU, NGO, private sector, foreign aid).</p>
                            
                            <p><strong>Remarks</strong><br>
                            Include relevant details about the assistance provided.</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
            ...
            setTimeout(function() {
                ...
                newEntry.innerHTML = `
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label for="recipient-${entryCount}" class="form-label">Recipient (LGU/Agency)</label>
                            <input type="text" class="form-control" id="recipient-${entryCount}" name="recipient[]" placeholder="e.g., Municipality of Nabunturan" required maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control number-input" id="quantity-${entryCount}" name="quantity[]" placeholder="0" min="0" onchange="calculateAmount(this)" required>
                        </div>
                        <div class="col-md-2">
                            <label for="unit-${entryCount}" class="form-label">Unit</label>
                            <input type="text" class="form-control" id="unit-${entryCount}" name="unit[]" placeholder="e.g., pack, piece" required maxlength="50">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control number-input" id="amount-${entryCount}" name="amount[]" placeholder="0.00" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="source-${entryCount}" class="form-label">Source</label>
        ...
        document.getElementById('assistanceToLGUsForm').addEventListener('submit', function(e) {
            e.preventDefault();
        ...
        document.getElementById('assistanceToLGUsForm').addEventListener('submit', function(e) {
            ...
            entries.forEach((entry, index) => {
                ...
                const recipient = entry.querySelector('input[name="recipient[]"]');
                ...
                if (!region.value || !province.value || !city.value || !recipient.value) {
                    isValid = false;
                    alert(`Please fill all location and recipient fields in entry ${index + 1}`);
                    e.preventDefault();
                    return;
                }
                ...
                if (!cluster.value) {
                    isValid = false;
                    alert(`Please select cluster in entry ${index + 1}`);
                    e.preventDefault();
                    return;
                }
                ...
                if (!unit.value) {
                    isValid = false;
                    alert(`Please enter unit in entry ${index + 1}`);
                    e.preventDefault();
                    return;
                }
                
                if (!costPerUnit.value || parseFloat(costPerUnit.value) < 0) {
                    isValid = false;
                    alert(`Please enter a valid cost per unit in entry ${index + 1}`);
                    e.preventDefault();
                    return;
                }
                ...
                if (!source.value) {
                    isValid = false;
                    alert(`Please select source in entry ${index + 1}`);
                    e.preventDefault();
                    return;
                }
            });
